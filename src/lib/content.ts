	...
	content: [
		...
		},
		{
			...
			content: [
				{
					type: "text",
					text: "// Pure functions have no side effects\nconst add = (a, b) => a + b;",
				},
			],
		},
		{
					...
					content: [
						{
							...
							content: [
								{
									type: "text",
									text: "First-class and higher-order functions",
								},
							],
						},
					],
											...
											content: [
												{
													...
													attrs: {
														latex:
															"reduce(f, [x_1, x_2, ..., x_n], init) = f(...f(f(init, x_1), x_2), ..., x_n)",
													},
												},
											],
										},
