...
import {
	slashCommand,
	suggestionItems,
} from "@/components/editor/extensions/core/slash";
...
} from "./extensions/spreadsheet/handsontable-utils";
...
const TailwindAdvancedEditor = ({
	...
	const createSimpleHTML = useCallback((json: JSONContent) => {
		...
		const processNode = (node: EditorNode) => {
		...
		if (json.content) {
			for (const node of json.content) {
				html += processNode(node as EditorNode);
			}
		}
